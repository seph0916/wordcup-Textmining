...
# 실시간 뉴스 수집과 분석 
# 뉴스1
url <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%B9%B4%ED%83%80%EB%A5%B4%20%EC%9B%94%EB%93%9C%EC%BB%B5%20%EC%9A%B0%EC%8A%B9%ED%9B%84%EB%B3%B4&sort=0&photo=0&field=0&pd=3&ds=2022.11.01&de=2022.11.20&cluster_rank=152&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:from20221101to20221120,a:all&start=61"
web <- GET(url)
web
...
# 뉴스2
url <- "https://search.naver.com/search.naver?where=news&query=%EC%B9%B4%ED%83%80%EB%A5%B4%20%EC%9B%94%EB%93%9C%EC%BB%B5%20%EC%9A%B0%EC%8A%B9%ED%9B%84%EB%B3%B4&sm=tab_opt&sort=0&photo=0&field=0&pd=3&ds=2022.10.10&de=2022.10.20&docid=&related=0&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so%3Ar%2Cp%3Afrom20221010to20221020&is_sug_officeid=0"
web <- GET(url)
web <- GET(url)
web
...
# 뉴스3
url <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%B9%B4%ED%83%80%EB%A5%B4%20%EC%9B%94%EB%93%9C%EC%BB%B5%20%EC%9A%B0%EC%8A%B9%ED%9B%84%EB%B3%B4&sort=0&photo=0&field=0&pd=3&ds=2022.10.20&de=2022.11.10&cluster_rank=45&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:from20221020to20221110,a:all&start=41"
web <- GET(url)
web
...
# 뉴스4
url <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%B9%B4%ED%83%80%EB%A5%B4%20%EC%9B%94%EB%93%9C%EC%BB%B5%20%EC%9A%B0%EC%8A%B9%ED%9B%84%EB%B3%B4&sort=0&photo=0&field=0&pd=3&ds=2022.11.10&de=2022.11.30&cluster_rank=20&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:from20221110to20221130,a:all&start=21"
web <- GET(url)
web
...
# 뉴스5
url <- "https://search.naver.com/search.naver?where=news&sm=tab_pge&query=%EC%B9%B4%ED%83%80%EB%A5%B4%20%EC%9B%94%EB%93%9C%EC%BB%B5%20%EC%9A%B0%EC%8A%B9%ED%9B%84%EB%B3%B4&sort=0&photo=0&field=0&pd=3&ds=2022.11.10&de=2022.11.30&cluster_rank=53&mynews=0&office_type=0&office_section_code=0&news_office_checked=&nso=so:r,p:from20221110to20221130,a:all&start=51"
web <- GET(url)
web
...
wordResult <- wordResult[-c(1:4,6:9,11,12,14:16,18)]
wordResult
...
news_C <- str_replace_all(news_C,"일보","")
news_C <- str_replace_all(news_C,"연합","")
news_C <- str_replace_all(news_C,"뉴스","")
news_C <- str_replace_all(news_C,"스타디움","")
news_C <- str_replace_all(news_C,"매체","")
news_C <- str_replace_all(news_C,"매일","")
news_C <- str_replace_all(news_C,"일한국","")
news_C <- str_replace_all(news_C,"신문","")
news_C <- str_replace_all(news_C,"서간","")
news_C <- str_replace_all(news_C,"선정","")
news_C <- str_replace_all(news_C,"시간","")
news_C <- str_replace_all(news_C,"한국","")
news_C <- str_replace_all(news_C,"카타르","")
news_C
...
tranrules <- apriori(wordtran, parameter=list(supp=0.1, conf=0.4)) 
